                ...
                @foreach($packages as $package)
                  <tr>
                      ...
                      <td class="d-flex">
                          ...
                          <a href="{{ route('package.edit',$package->id) }}" class="btn btn-sm btn-primary mr-2" data-toggle="modal" data-target="#viewModal{{ $package->id }}"><i class="fas fa-edit"></i></a>
                          ...
                          <div class="modal fade" id="viewModal{{ $package->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                           ...
                           <a href="{{ route('package.delete',['id'=>$package->id]) }}"  class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleted-modal{{ $package->id }}"><i class="fas fa-trash"></i></a>
