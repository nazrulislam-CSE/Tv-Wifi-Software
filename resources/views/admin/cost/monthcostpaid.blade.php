          ...
          <div class="col-12">
           <div class="card">
               <div class="d-flex justify-content-between align-items-center">
                  ...
                  This Month Cost: Total {{ $todaybills }} {{ config('app.currency') }} (Date Range: from @php $tt=date('Y-m-0 00:00:00'); echo $tt @endphp to @php $tt=date('Y-m-d H:i:s'); echo $tt @endphp (UTC)
                    </h5>
                </div>
              <!-- /.card-header -->
              <div class="card-body">
