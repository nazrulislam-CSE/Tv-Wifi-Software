           ...
           <div class="card">
               <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title pl-3">
                  Todays Cost: Total {{ $todaybills }} {{ config('app.currency') }} (@php $tt=date('Y-m-d H:i:s'); echo $tt @endphp)(UTC)
                    </h5>
                </div>
              <!-- /.card-header -->
              <div class="card-body">
              ...
              <tbody>
                @foreach($costs as $cost)
                  <tr>
                      ...
                      <td>
                        <a href="{{ route('cost.edit',$cost->id) }}" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#viewModal{{ $cost->id }}"><i class="fas fa-edit"></i></a>
                        ...
                        <a href="{{ route('cost.delete',['id'=>$cost->id]) }}"  class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleted-modal{{ $cost->id }}"><i class="fas fa-trash"></i></a>
