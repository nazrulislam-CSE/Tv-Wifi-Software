                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                @error('flat_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                <input type="text" name="flat_no" class="form-control" id="room" placeholder="Enter Flat No (Room)">
                                            </div>
                                             ...
                                             <div class="form-group">
                                                @error('card_no')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                <input type="text" name="card_no" class="form-control" id="email" placeholder="Enter Card No" >
                                            </div>
                                            ...
                                            <div class="form-group">
                                                @error('phone')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                                <input type="number" name="phone" class="form-control" id="number" placeholder="Enter Phone No" >
                                            </div>
