              ...
              <tbody>
                @foreach($cashs as $cash)
                  <tr>
                      ...
                      <td>
                        <a href="{{ route('cash.edit',$cash->id) }}" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#viewModal{{ $cash->id }}">Edit</a>
                        ...
                        <a href="{{ route('cash.delete',['id'=>$cash->id]) }}"  class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleted-modal{{ $cash->id }}">Delete</a>
