              ...
              <tbody>
                @foreach($buildings as $building)
                  <tr>
                      <td>{{ $i++ }}</td>
                      <td>
                        <a href="{{ route('building.edit',$building->id) }}" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#viewModal{{ $building->id }}">Edit</a>
                        ...
                        <div class="modal fade" id="viewModal{{ $building->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          ...
                          <a href="{{ route('building.delete',['id'=>$building->id]) }}"  class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleted-modal{{ $building->id }}">Delete</a>
